...
public class DormitoryServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (method) {
            case "selectAll":
                req.setAttribute("dormitoryList", this.dormitoryService.selectAll());
            ...
            case "select":
                ...
                req.setAttribute("dormitoryList", this.dormitoryService.select(key, value));
                req.setAttribute("buildingList", this.buildingService.selectAll());
                req.getRequestDispatcher("dormitorymanager.jsp").forward(req, resp);
                break;
            case "save":
                ...
                resp.sendRedirect("/dormitory?method=selectAll");
                break;
            case "update":
