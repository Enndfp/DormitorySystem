        ...
        <div class="col-sm-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" class="form-inline" action="/student?method=select" method="post">
            ...
            <div class="table-responsive">
                <table class="table table-hover ">
                    ...
                    <c:forEach items="${studentList}" var="student">
                        <tr>
                            <td style="line-height: 33px">${student.id}</td>
                            <td style="line-height: 33px">${student.dormitoryName}</td>
                            <td style="line-height: 33px">${student.number}</td>
                            <td style="line-height: 33px">${student.name}</td>
                            <td style="line-height: 33px">${student.gender}</td>
                            <td style="line-height: 33px">${student.state}</td>
                            <td style="line-height: 33px">${student.createDate}</td>
                            <td>
                                <div class="btn-group">
