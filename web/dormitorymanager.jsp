        ...
        <div class="col-sm-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" class="form-inline" action="/dormitory?method=select" method="post">
            ...
            <div class="table-responsive">
                <table class="table table-hover ">
                    ...
                    <c:forEach items="${dormitoryList}" var="dormitory">
                        <tr>
                            <td style="line-height: 33px">${dormitory.id}</td>
                            <td style="line-height: 33px">${dormitory.buildingName}</td>
                            <td style="line-height: 33px">${dormitory.name}</td>
                            <td style="line-height: 33px">${dormitory.type}</td>
                            <td style="line-height: 33px">${dormitory.available}</td>
                            <td style="line-height: 33px">${dormitory.telephone}</td>
                            <td>
                                <div class="btn-group">
