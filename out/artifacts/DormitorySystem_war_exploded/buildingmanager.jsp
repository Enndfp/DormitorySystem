        ...
        <div class="col-sm-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" class="form-inline" action="/building?method=select" method="post">
            ...
            <div class="table-responsive">
                <table class="table table-hover ">
                    ...
                    <c:forEach items="${buildingList}" var="building">
                        <tr>
                            <td style="line-height: 33px">${building.id}</td>
                            <td style="line-height: 33px">${building.name}</td>
                            <td style="line-height: 33px">${building.introduction}</td>
                            <td style="line-height: 33px">${building.adminName}</td>
                            <td>
                                <div class="btn-group">
