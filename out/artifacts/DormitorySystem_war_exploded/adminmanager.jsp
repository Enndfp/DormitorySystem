        ...
        <div class="col-sm-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" class="form-inline" action="/dormitoryAdmin?method=select" method="post">
            ...
            <div class="table-responsive">
                <table class="table table-hover ">
                    ...
                    <c:forEach items="${dormitoryAdminList}" var="dormitoryAdmin">
                        <tr>
                            <td style="line-height: 33px">${dormitoryAdmin.id}</td>
                            <td style="line-height: 33px">${dormitoryAdmin.username}</td>
                            <td style="line-height: 33px">${dormitoryAdmin.password}</td>
                            <td style="line-height: 33px">${dormitoryAdmin.name}</td>
                            <td style="line-height: 33px">${dormitoryAdmin.gender}</td>
                            <td style="line-height: 33px">${dormitoryAdmin.telephone}</td>
                            <td>
                                <div class="btn-group">
